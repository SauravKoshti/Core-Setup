...
<head>
  ...
  <title>AdminLTE 3 | Blood Donor List </title>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Listed All Donor List</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tr>
                 ...
                 <td><?php echo $raw['Mobile']; ?></td>
                  ...
                  <td>
                    ...
                    <a href="donor_delete.php?id=<?php echo $raw['id']; ?>">  <i class="fa fa-trash"  style="font-size:22px" ></i> </a>
                  </td>
                </tr>
                 <?PHP } ?>
                </tbody>
